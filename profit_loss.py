...
def profit_and_loss(data):
    ...
    with open('summaryreport.txt', 'a') as outfile:
        if text3 == 0 :
            ...
            outfile.write("[Highest Net Profit  Surplus]: Day: %s, Amount: SGD%s \n" % (text2[0], abs(text2[1])))
        elif text3 == 1:
